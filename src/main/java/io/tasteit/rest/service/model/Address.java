...
public class Address {
    ...
    public void setLocalAddressLineOne(String localAddressLineOne) {
	this.localAddressLineOne = localAddressLineOne;
    }

    public void setLocalAddressLineTwo(String localAddressLineTwo) {
	this.localAddressLineTwo = localAddressLineTwo;
    }
